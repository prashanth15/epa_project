...
@Service
public class PlanningTheProject {
    ...
    private double calculateScore(PlanningDataModel data) {
        ...
        double scoreRange = data.getHours() - data.getEstimated_hours();

        if (scoreRange < -10) {
            score = 90;
        } else if (scoreRange >= -10 && scoreRange < 10) {
            score = 100;
        } else if (scoreRange >= 10 && scoreRange < 20) {
            score = 80;
        } else if (scoreRange >= 20 && scoreRange < 30) {
            score = 70;
